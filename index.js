...
program
  ...
  .option('-c, --config <file>',        'path to config file (default: use-obfuscator.config.js)')
  .action(async (include, opts) => {
    ...
    if (!finalOpts.include) {
      console.error('[error] No CSS files specified. Pass a file argument or create use-obfuscator.config.js\n');
